...
class todo:
    def __init__(self, root):
        ...
        self.label = Label(self.root,text = 'To-Do-List-App', 
                           font = 'ariel, 25 bold', width =10,bd=5,bg='green', fg='white')
        self.label.pack(side='top', fill=BOTH)

        self.label2 = Label(self.root,text = 'Add Task', 
                           font = 'ariel, 18 bold', width =10,bd=5,bg='green', fg='white')
...
#-----------------creating buttons------------------#
        ...
        self.button = Button(self.root, text='Add', font='sarif, 20 italic', 
                             width=10,bd=5,bg='green',fg='white',command=add)
        self.button.place(x=30,y=180)

        self.button2 = Button(self.root, text='Delete', font='sarif, 20 italic', 
                              width=10,bd=5,bg='green',fg='white',command=delete)
